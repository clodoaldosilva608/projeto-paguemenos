...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dashboard de metas, vendas e performance da equipe em tempo real." },
      ...
      { property: "og:description", content: "Dashboard de metas, vendas e performance da equipe em tempo real." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Orion" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Orion Dashboard — Metas & Performance" },
      { name: "twitter:description", content: "Dashboard de metas, vendas e performance da equipe em tempo real." },
    ],
    links: [
